...
extern struct osdMetadataHandle * alloc_osd_metadata(afs_int32 length, char **data);
extern afs_int32 print_osd_metadata_verb(struct osdMetadataHandle *mh,
				         afs_int32 verbose, struct OsdList *ol);
extern void free_osd_metadata(struct osdMetadataHandle *mh);
