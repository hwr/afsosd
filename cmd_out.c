...
struct TableCell* setTableCell(struct TableCell *aCell, char *Content, int Width,
			       int Justification)
{
    aCell->Width=Width;
...
struct TableCell* appendTableCell(struct TableCell *aCell, char *Content, int Width,
				  int Justification)
{
    /* go to end of list*/
...
void setTableLayout(struct Table *Table,int CellsperRow,int *allCellWidth,
		    int *chosenIdx  )
{
    /*
